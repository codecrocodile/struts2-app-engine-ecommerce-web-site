...
<section id="blog">
	<div class="grid_9">
	  <h3>Groovy Fly on the use of our website...</h3>
	    <img alt="legal pen and paper" src="images/pen-and-paper.png"  class="imgborder alignleft" />
	  <p>
	    It can be easy to forget that people spend a lot of time and money developing websites and its content (including text, images, 
	    video and other media). This is especially true because much of a website's content is freely available and very easy to copy
	    and use yourself. We must be careful to use this content as the original author intended and give credit to them when required.  
	  </p>
	  <p>
	    We know that we have the most intelligent customers at Groovy Fly - otherwise why would you be here? :-) 
	    Just be a good person, do not steal or try to offend anyone and we will do the same for you. It is mostly common sense and we are
	    sure our customers have that in abundance. If you would like more detailed information on the contracted obligations between 
	    Groovy Fly and yourself please find below our official terms and conditions document for the use of this website. 
	  </p>
	</div>
	<div class="clear"></div>

	<div class="grid_9 toggle_block">
		<h4>Official Groovy Fly Terms and Conditions</h4>
		<div class="toggle_content">
			<div class="inner"> 
			    ...
			    <p>You must be at least 18 years of age to use our website to purchase any products and/or download any material that we provide free of charge. By using our website and by agreeing to these terms and conditions you warrant and represent that you are at least 18 years of age before purchasing any products and/or download any material that we provide free of charge.</p>
			    ...
			    <h3>(2) Licence to use website</h3>
			    ...
			    <p>You may view, download for caching purposes only, and print pages or sections of pages from the website for your own personal use, subject to the restrictions set out below and elsewhere in these terms and conditions.</p>
			    <p>You must not:</p>
			    <ol class="lower-alpha">
			        ...
			        <li>redistribute material from this website except for content specifically and expressly made available for redistribution (such as our newsletter, RSS feed articles).</li>
			    </ol>
			    <p>Where content is specifically made available for redistribution, it may only be redistributed within your organisation or your on your organisation's website provided you provide a link back to our site.</p>
			    ...
			    <p>Access to certain areas of our website is restricted. We reserve the right to restrict access to restricted areas of our website, or indeed our whole website, at our discretion.</p>
			    ...
			    <h3>(16) Registrations and authorisations</h3>
			    <p>We are not currently registered with any trade our professional organisations.</p>
			    <p>We are not currently registered for VAT.</p> <%-- Our VAT number is [NUMBER]. --%>
			    
			    <h3>(17) Our details</h3>
			    <p>The full name of our company is Groovy Fly.</p>
			    <p>Our address is 3 Aillort Place, East Mains, East Kilbride, South Lanarkshire, Scotland, G74 4LL.</p>
			    <p>You can contact us by email to support@groovyfly.com</p>
			</div>
		</div>    
		</div>
	<div class="clear"></div>
