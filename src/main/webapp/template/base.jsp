...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="description" content="<tiles:getAsString name="meta_description" ignore="true" />" />
    <meta name="keywords" content="<tiles:getAsString name="meta_keywords"  ignore="true"/>" />
    ...
    <script type="text/javascript">
	    ...
	    $(document).ready(function () {
	        ...
	        if (jQuery.cookie('cc_cookie_decline') == "cc_cookie_decline") {
	            ...
	            // TODO put the google analytics here
	        }
	    }); 
